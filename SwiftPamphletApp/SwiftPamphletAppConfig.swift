...
struct SPC {
    static let gitHubAccessToken = ""
    //static let gitHubAccessToken = "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" // 在这里写上 Github 的access token。在 https://github.com/settings/tokens 申请你的access token。
